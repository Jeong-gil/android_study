...
public class DeleteContentByuserID extends AsyncTask<String,Void,String> {

    private String userID;

    private URL Url;
    private String URL_Adress = "http://10.100.103.96:8090/adJspProject/DeleteContentByuserID.jsp";
