...
import com.cookandroid.dbexample.Custom_Adapter;
import com.cookandroid.dbexample.UserInfo;
...
public class NetworkGet extends AsyncTask<String,Void,String> {
    ...
    private URL Url;
    private String URL_Adress = "http://10.100.103.16/testDB/testDB3_search.jsp";
